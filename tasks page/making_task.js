...
function saveTask(userId) {
    ...
    // Parse the time input to determine whether it's AM or PM
    const parsedTime = new Date("2000-01-01T" + time).toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true });

    // Construct task object
    const task = {
        title: title,
        date: date,
        time: parsedTime, // Store the parsed time with AM/PM indication in the task object
